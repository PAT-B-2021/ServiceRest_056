...
namespace ServiceRest_056_HasnaShabrina
{
    ...
    // You can add XSD files into the project. After building the project, you can directly use the data types defined there, with the namespace "ServiceRest_056_HasnaShabrina.ContractType".
    [DataContract]
